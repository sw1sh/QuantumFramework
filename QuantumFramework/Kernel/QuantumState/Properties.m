...
QuantumStateProp[qs_, "NumericQ"] := ArrayQ[Replace[qs["State"], sa_ ? SparseArrayQ :> sa["ExplicitValues"]], 1 | 2, NumericQ] || qs["Basis"]["NumericQ"]

QuantumStateProp[qs_, "NumberQ"] := ArrayQ[Replace[qs["State"], sa_ ? SparseArrayQ :> sa["ExplicitValues"]], 1 | 2, InexactNumberQ] || qs["Basis"]["NumberQ"]
